          ...
          {experiences.map((exp, index) => (
            ...
            >
              <div className="md:flex items-center justify-between">
                ...
                <div className="hidden md:block w-4 h-4 rounded-full bg-indigo-600 dark:bg-indigo-400 absolute left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 z-10 border-4 border-slate-50 dark:border-slate-950 box-content"></div>
