        ...
        >
          <div className="relative w-[300px] h-[300px] md:w-[400px] md:h-[400px]">
            ...
            <div className="absolute inset-0 z-10 flex items-end justify-center -translate-y-4 md:-translate-y-8">
              ...
              <div className="absolute -bottom-3 md:-bottom-2 left-1/2 -translate-x-1/2 w-[120%] h-1/3 bg-gradient-to-t from-slate-50 via-slate-50/80 to-transparent dark:from-slate-950 dark:via-slate-950/80 pointer-events-none z-20" />
            </div>
