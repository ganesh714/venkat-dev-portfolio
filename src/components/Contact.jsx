  ...
  return (
    <section id="contact" className="py-24 bg-slate-900 flex items-center justify-center px-4">
      <div className="w-full max-w-2xl text-center">
        ...
        {/* Glassmorphism Card */}
        <div className="bg-slate-800/50 backdrop-blur-md border border-slate-700/50 rounded-2xl p-8 md:p-12 shadow-xl">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-6">
            ...
            <a
              ...
              className="group flex items-center justify-center gap-3 w-full sm:w-auto px-6 py-3 bg-blue-600/20 hover:bg-blue-600/40 text-blue-300 border border-blue-500/30 rounded-xl transition-all duration-300 hover:shadow-[0_0_20px_rgba(59,130,246,0.4)]"
