...
const Contact = () => {
  return (
    <section id="contact" className="py-24 bg-slate-900 flex items-center justify-center px-4">
      <motion.div 
      ...
      >
        ...
        <h2 className="text-4xl md:text-5xl font-extrabold mb-8 relative inline-block">
          ...
          <motion.div 
            className="absolute -bottom-2 left-0 h-1 bg-gradient-to-r from-blue-400 to-pink-500 rounded-full"
            initial={{ width: 0 }}
        ...
        {/* Glassmorphism Card */}
        <motion.div 
          className="bg-slate-800/50 backdrop-blur-md border border-slate-700/50 rounded-2xl p-8 md:p-12 shadow-xl"
        ...
        >
          <p className="text-slate-300 text-lg mb-10 leading-relaxed">
            I'm currently open for new opportunities and collaborations. Whether you have a question, a project idea, or just want to connect, feel free to reach out. I'll try my best to get back to you!
          </p>

          {/* Button Group */}
          <div className="flex flex-col sm:flex-row justify-center items-center gap-6">
            {/* Email Button with Pulse */}
            <motion.a
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 group-hover:rotate-12 transition-transform" fill="currentColor" viewBox="0 0 24 24">
